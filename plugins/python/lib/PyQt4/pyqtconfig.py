...
_pkg_config = {
    'pyqt_bin_dir':      'c:\\Python27',
    'pyqt_config_args':  '',
    'pyqt_mod_dir':      'c:\\Python27\\Lib\\site-packages\\PyQt4',
    'pyqt_modules':      'QtCore QtGui QtNetwork QtSql QtTest QtXml',
    'pyqt_sip_dir':      'c:\\Python27\\sip\\PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_6_0 -x Py_v3 -g',
    'pyqt_version':      0x040801,
    'pyqt_version_str':  'snapshot-4.8.1-285d517097ec',
    'qt_data_dir':       'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0',
    'qt_dir':            'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0\\include',
    'qt_lib_dir':        'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040600,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0\\include',
    'INCDIR_X11':               '',
    'LFLAGS':                   '/NOLOGO',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0\\lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'D:\\dev\\SDK\\qt-everywhere-opensource-src-4.6.0\\bin\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
